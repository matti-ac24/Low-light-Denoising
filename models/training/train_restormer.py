...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--base-channels', type=int, default=32, help='Restormer base feature channels')
    parser.add_argument(
        '--num-blocks',
        type=str,
        default='2,2,4,2',
        help='Transformer blocks per stage as n1,n2,n3,n4',
    )
    parser.add_argument(
        '--heads',
        type=str,
        default='1,2,4,8',
        help='Attention heads per stage as h1,h2,h3,h4',
    )
    parser.add_argument('--ffn-expansion', type=float, default=2.66, help='GDFN expansion factor')
